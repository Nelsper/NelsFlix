const dbMarvel = [
  {
    ...
    descrip:
      "La película sigue a Steve Rogers, un joven enclenque que se convierte en el Capitán América gracias a un experimento durante la Segunda Guerra Mundial. Lucha contra los nazis, liderados por el Cráneo Rojo, utilizando sus nuevas habilidades sobrehumanas para proteger la libertad y la justicia.",
    year: "2011",
  ...
  },
  {
    ...
    title: "Eternals",
    descrip:
      "Los Eternos, una raza de seres inmortales enviados a la Tierra por los Celestiales, emergen de su escondite después de miles de años para enfrentarse a una nueva amenaza: los Desviantes. Los Eternos deben unirse para salvar a la Tierra, pero en el camino deben lidiar con sus propios secretos y conflictos.",
    year: "2021",
    img: "Eternals.jpg",
    alt: "poster eternals",
